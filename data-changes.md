...
2. In the <code>getData()</code> function (lines 38-740, I retrieve the spreadsheet data in the JSON feed format: <br /><img style="width:60%" src="images/google-rhetmap-json.png" />
