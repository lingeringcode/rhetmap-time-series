...
export const paintPredictChart = (EXISTING) => {

  // Fetch the data
  fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vTvmYZA6OFJD_BoxIr_qmj0sbCP2Itd_J45Q3CFli5g66nfRPu64Kj_WwU95XvQjQiOEWHxpGtymD0a/pub?gid=231966111&single=true&output=csv').then((response) => {
    ...
    const mapExistingWeeksToPosts = (w,e) => {
